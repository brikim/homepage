...
import { SiLg, SiLinux, SiOpera, SiPlex, SiRoku, SiSafari, SiSamsung } from "react-icons/si";
  ...
  return (
    <div className="z-10 self-center ml-1 mr-1 h-3.5">
      <div className="w-4 text-sm z-10 overflow-hidden justify-start">
        {(platform === "android" || platform === "chromecast" || platform === "android tv" ||
          platform === "fire tv") && <BsAndroid2 className={opacity} />}
